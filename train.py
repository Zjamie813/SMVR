# copy from https://github.com/anosorae/IRRA
import os
...
from model import build_model  # change
from utils.metrics import Evaluator # change
from utils.options import get_args # change
